  ...
  return (
    <main className="bg-gray-200 h-screen">
      <nav className="max-w-5xl mx-auto py-2 px-5">
        <h1 className="text-[#3F3D56] text-3xl flex items-center space-x-1">
          <GiNotebook />
          <span className="font-bold">Proy</span>ecto
        </h1>
      </nav>
      <div className="max-w-5xl mx-auto px-5 pt-5 md:pt-10 flex flex-col sm:flex-row items-center justify-center">
        <div className="w-full lg:w-1/2 mr-5Name">
          ...
          <button className="relative px-6 py-3 font-bold text-[#2F2E41] group mt-10">
            <span
